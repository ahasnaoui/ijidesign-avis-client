...
public class ProduitSante implements Serializable, IProduitSante {

	private static final long serialVersionUID = 7254589000745337287L;

	public enum Code_produit_sante {
		hospi_plus, responsable,eco, essentielle100, equilibre, confort,serenite, plenitude, protection, precaution, precision, perfection 
	};

	final Code_produit_sante code_produit_sante;
	...
	public ProduitSante(Code_produit_sante code_produit_sante) {
		super();
		this.code_produit_sante = code_produit_sante;
	}

	public ProduitSante(Code_produit_sante code_produit_sante, BigDecimal cotisation_adherent,
	 ...
	 * ()
	 */
	public Code_produit_sante getCode_produit_sante() {
	...
	public String toString() {
		return "ProduitSante [code_produit_sante=" + code_produit_sante + "\n cotisation_base_adherent="
				+ cotisation_base_adherent + "\n cotisation_base_conjoint=" + cotisation_base_conjoint
				+ "\n cotisations_base_enfant=" + cotisations_base_enfant + "\n cotisation_assistance="
				...
				+ "\n cotisation_cancer_adherent=" + cotisation_cancer_adherent + "\n cotisation_cancer_conjoint="
				+ cotisation_cancer_conjoint + "\n cotisations_cancer_enfant=" + cotisations_cancer_enfant
				+ "\n cotisation_protection_juridique=" + cotisation_protection_juridique
				+ "\n cotisation_assurance_scolaire=" + cotisation_assurance_scolaire + "]";
	}
