...
public class Table {
    ...
    public void appendColumn(StringBuilder sb, Object value, boolean last) throws Exception {
        ...
        if (value == null) {
            ...
            value = StringUtil.replace((String) value, _SAFE_TABLE_CHARS[0], _SAFE_TABLE_CHARS[1]);
    ...
    private static final String[][] _SAFE_TABLE_CHARS = { { StringPool.COMMA, StringPool.NEW_LINE, StringPool.RETURN },
            { Table._SAFE_TABLE_COMMA_CHARACTER, Table._SAFE_TABLE_NEWLINE_CHARACTER, Table._SAFE_TABLE_RETURN_CHARACTER } };
