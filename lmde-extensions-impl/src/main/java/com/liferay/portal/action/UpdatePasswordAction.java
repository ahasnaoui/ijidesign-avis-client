...
public class UpdatePasswordAction extends Action {
    ...
    public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest request,
        ...
        if (Validator.isNull(cmd)) {
            ...
            Layout changerMdp = LayoutLocalServiceUtil.getFriendlyURLLayout(themeDisplay.getScopeGroup().getGroupId(),
                    false, PropsUtil.get("lmde.page.changerMotDePasse"));
            String path = PortalUtil.getLayoutFullURL(changerMdp, themeDisplay) + "?ticketKey="
                    + request.getParameter("ticketKey");
        ...
        try {
            ...
            session.setAttribute(LMDEConstants.MDP_REINIT, true);
            ...
            if (e instanceof UserPasswordException) {
                ...
                Layout changerMdp = LayoutLocalServiceUtil.getFriendlyURLLayout(themeDisplay.getScopeGroup()
                        .getGroupId(), false, PropsUtil.get("lmde.page.changerMotDePasse"));
                String path = PortalUtil.getLayoutFullURL(changerMdp, themeDisplay) + "?ticketKey="
                        + request.getParameter("ticketKey");
                response.sendRedirect(path);
                return null;
    ...
    protected void updatePassword(HttpServletRequest request, HttpServletResponse response, ThemeDisplay themeDisplay,
            Ticket ticket) throws Exception {

        AuthTokenUtil.checkCSRFToken(request, UpdatePasswordAction.class.getName());
