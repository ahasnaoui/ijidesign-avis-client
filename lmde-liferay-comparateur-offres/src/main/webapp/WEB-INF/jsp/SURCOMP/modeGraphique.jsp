							...
							<div class="col-xs-12 col-sm-4 col-md-3">							
								<div class="formula" id="comp-${offre.codeOffre}">
									...
									<div class="formula-garanties">
										...
										<c:forTokens items="${codesGarantiesSurComplementairesGraphicMode}" delims="," var="codeGarantieOuService">			
										...
										<c:forTokens items="${codesServicesSurComplementaires}" delims="," var="codeGarantieOuService">			
